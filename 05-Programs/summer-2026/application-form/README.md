...
- **Fallback:** if Supabase isn't configured yet, or the server can't be reached, the form downloads two files to the parent's device and asks them to email the file to `apply@thenormal.school`:
